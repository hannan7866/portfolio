...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    subtitle: "Collaborative Full-Stack & Frontend Workspace Web Platform",
    categoryType: "production",
  ...
  return (
    <div className="[perspective:1200px] w-full h-full">
      ...
      >
        {/* Image area */}
        <div
          className="relative w-full flex-1 min-h-0 overflow-hidden rounded-2xl bg-sunken border border-rule mb-4 sm:mb-5"
        ...
        >
          ...
          <div className="absolute inset-0 bg-sunken/25 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
          ...
          <div className="absolute top-3 left-3 right-3 sm:top-4 sm:left-4 sm:right-4 flex items-center justify-between pointer-events-none gap-2 z-10">
            <span className="px-3 py-1 rounded-full bg-sunken/80 backdrop-blur-md border border-rule text-[11px] font-semibold text-ink truncate">
        ...
        <div className="flex items-start justify-between gap-4 shrink-0 relative z-10">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs sm:text-sm text-graphite mt-1 font-normal line-clamp-2 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-1.5 mt-2.5">
              {project.tags.slice(0, 5).map((tag) => (
                <span
                  key={tag}
                  className="px-2 py-0.5 rounded-md bg-surface border border-rule text-[10px] font-mono text-graphite"
                >
                  {tag}
                </span>
              ))}
          ...
          <div className="flex items-center gap-2 shrink-0 self-center">
            <button
              ...
              className="w-9 h-9 rounded-full bg-surface hover:bg-surface/80 border border-rule flex items-center justify-center text-graphite hover:text-ink transition-colors cursor-pointer"
            >
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 pt-6 pb-3 shrink-0 z-30 relative">
          <div className="flex items-end justify-between gap-4">
            ...
            <div className="hidden sm:flex flex-col items-end gap-1">
              <span className="text-[10px] font-mono text-graphite uppercase tracking-widest">Scroll Progress</span>
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-10">
            ...
            <motion.div
              ...
              className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto bg-surface border border-rule rounded-3xl p-6 sm:p-8 shadow-2xl z-10"
            >
              <button
                onClick={() => setSelectedProject(null)}
              ...
              <div className="relative aspect-video w-full rounded-2xl overflow-hidden mb-6 border border-rule">
                <Image
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                ...
                {selectedProject.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 rounded-full bg-surface border border-rule text-xs font-medium text-ink"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div className="mb-6 bg-sunken/60 rounded-2xl p-4 sm:p-5 border border-rule">
                <h4 className="text-xs font-bold uppercase tracking-wider text-graphite mb-3">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-rule">
                <div className="flex items-center gap-3">
                  ...
                  {selectedProject.githubUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="px-5 py-2.5 rounded-full bg-surface hover:bg-surface/80 border border-rule text-ink text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer"
                    >
                ...
                <button
                  onClick={() => setSelectedProject(null)}
                  className="text-xs text-graphite hover:text-ink transition-colors cursor-pointer"
                >
                  Close
                </button>
              </div>
