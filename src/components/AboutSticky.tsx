      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 lg:sticky lg:top-28 self-start">
          ...
          >
            ...
            <div className="absolute -top-24 -left-24 w-48 h-48 bg-arc/15 rounded-full blur-3xl pointer-events-none" />
            ...
            <div className="relative aspect-[3/4] w-full rounded-2xl overflow-hidden border border-rule bg-sunken flex items-center justify-center">
              ...
              <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-sunken/90 backdrop-blur-md border border-rule text-xs font-semibold text-ink">
                  <ShieldCheck className="w-4 h-4 text-arc" />
                ...
                <div className="flex items-center gap-1 text-[11px] text-graphite font-medium px-2.5 py-1 rounded-full bg-sunken/90 backdrop-blur-md">
                  <MapPin className="w-3 h-3 text-arc" />
            ...
            <div className="mt-5 flex flex-col gap-2">
              <div className="flex items-center justify-between">
                ...
                <span className="inline-flex items-center gap-1 text-[10px] px-2.5 py-0.5 rounded-full bg-arc/20 text-arc font-semibold border border-arc/30">
              ...
              <div className="mt-3 flex items-center gap-2">
                <a
                  ...
                  className="flex-1 py-2 px-2.5 rounded-xl bg-surface hover:bg-surface/80 border border-rule hover:border-arc text-xs font-medium text-graphite hover:text-ink flex items-center justify-center gap-1.5 transition-all group/btn shadow-sm cursor-pointer"
                >
                  <Mail className="w-3.5 h-3.5 text-arc group-hover/btn:scale-110 transition-transform shrink-0" />
                  <span className="truncate">Mail</span>
                </a>
                <a
                  href="tel:+917310542113"
                  title="Call +91-7310542113"
                  className="flex-1 py-2 px-2.5 rounded-xl bg-surface hover:bg-surface/80 border border-rule hover:border-arc text-xs font-medium text-graphite hover:text-ink flex items-center justify-center gap-1.5 transition-all group/btn shadow-sm"
                >
                  <Phone className="w-3.5 h-3.5 text-arc group-hover/btn:scale-110 transition-transform shrink-0" />
                ...
                <a
                  ...
                  className="flex-1 py-2 px-2.5 rounded-xl bg-surface hover:bg-surface/80 border border-rule hover:border-arc text-xs font-medium text-graphite hover:text-ink flex items-center justify-center gap-1.5 transition-all group/btn shadow-sm"
                >
                  <LinkedinIcon className="w-3.5 h-3.5 text-arc group-hover/btn:scale-110 transition-transform shrink-0" />
            ...
            <div className="mt-6 grid grid-cols-3 gap-2 pt-4 border-t border-rule text-center">
              ...
              <div>
                <span className="text-lg font-extrabold text-ember block">1,000+</span>
        ...
        <div className="lg:col-span-7 flex flex-col gap-12">
          ...
          >
            <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-arc">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-ink u-head">
              ...
              <span className="text-arc">real-world problems</span>.
            </h2>
          ...
          >
            <h3 className="text-xl font-bold text-ink tracking-tight flex items-center gap-2">
              <Terminal className="w-4 h-4 text-arc" />
              Engineering Philosophy
            </h3>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-5 rounded-2xl bg-surface border border-rule flex flex-col gap-2">
                <span className="text-xs font-mono font-bold text-arc">01.</span>
              ...
              <div className="p-5 rounded-2xl bg-surface border border-rule flex flex-col gap-2">
                <span className="text-xs font-mono font-bold text-arc">02.</span>
              ...
              <div className="p-5 rounded-2xl bg-surface border border-rule flex flex-col gap-2">
                <span className="text-xs font-mono font-bold text-arc">03.</span>
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="p-6 rounded-2xl bg-surface border border-rule hover:border-ink transition-colors">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-2">
                  <h4 className="text-base font-bold text-ink flex items-center gap-2">
                    <Briefcase className="w-4 h-4 text-arc" />
                    Full-Stack Developer — Lala Motors
                  </h4>
                  <span className="text-xs font-mono text-ember">Jan 2025 — Present (1 yr 8 mos)</span>
                </div>
                ...
                <ul className="flex flex-col gap-2 text-xs text-graphite">
                  <li className="flex items-start gap-2">
                    <span className="text-arc mt-0.5">▹</span>
                ...
                <div className="p-5 rounded-2xl bg-surface border border-rule flex flex-col justify-between gap-2">
                  <div>
                    <div className="flex items-center gap-2 mb-1.5">
                      <Award className="w-4 h-4 text-arc" />
              ...
              <div className="p-6 rounded-2xl bg-surface border border-rule hover:border-ink transition-colors">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-2">
                  <h4 className="text-base font-bold text-ink flex items-center gap-2">
                    <GraduationCap className="w-4 h-4 text-arc" />
                    B.Tech in Computer Science and Engineering
                  </h4>
                  <span className="text-xs font-mono text-ember">July 2021 — June 2025</span>
                </div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="p-6 rounded-3xl bg-surface border border-arc/30 flex flex-col sm:flex-row items-center justify-between gap-4"
          >
            <div>
            ...
            <button
              ...
              className="px-6 py-3 rounded-full bg-arc text-arc-ink font-semibold text-xs tracking-wide hover:bg-arc/90 hover:scale-105 transition-all shrink-0 flex items-center gap-2 cursor-pointer"
            >
